...
def create_evaluators_for_documentation():
    ...
    return [
        ...
        LangChainStringEvaluator(
            ...
            config={
                "criteria": {
                    "conciseness_alignment": (
                        "Does the prediction match the same verbosity level "
                        "as the reference? "
                        "If reference is verbose (many sentences, detailed "
                        "explanations), "
            ...
            prepare_data=prepare_data_with_reference,  # type:ignore
        ),
        ...
        LangChainStringEvaluator(
            ...
            config={
                "criteria": {
                    "detail_alignment": (
                        "Does the prediction match the same technical detail level "
                        "as the reference? "
                        "If reference includes technical details (types, parameters, "
                        "code examples), "
                        "prediction should also include them. If reference is "
                        "high-level "
            ...
            config={
                "criteria": {
                    "tone_style_alignment": (
                        "Does the prediction match the same tone and writing style as "
                        "the reference? "
                        "Compare formality level (formal vs informal), language "
                        "complexity "
                        "(technical jargon vs accessible), and format (narrative "
                        "paragraphs vs "
        ...
        LangChainStringEvaluator(
            ...
            config={
                "criteria": {
                    "structure_alignment": (
                        "Does the prediction follow the SAME STRUCTURE as the "
                        "reference? "
                        "Same sections (e.g., Context, Objectives, Technologies, "
                        "Critical Points)? "
            ...
            config={
                "criteria": {
                    "content_coverage": (
                        ...
                        "If reference mentions 'Critical Points' (e.g., SQL injection, "
                        "missing cache), "
                        "prediction should cover these. If reference lists specific "
                        "technologies, "
            ...
            config={
                "criteria": {
                    "terminology_consistency": (
                        "Does the prediction use the SAME TERMINOLOGY as the "
                        "reference? "
                        "Same technical terms, same naming conventions, same "
                        "abbreviations "
            ...
            config={
                "criteria": {
                    "faithfulness": (
                        ...
                        "Doesn't invent features, classes, or functionality that "
                        "don't exist in the code? Doesn't add assumptions about "
                        "code behavior that wasn't shown?"
                    )
                },
                "normalize_by": 10,
            },
            prepare_data=prepare_data,  # type:ignore
        ),
    ]
