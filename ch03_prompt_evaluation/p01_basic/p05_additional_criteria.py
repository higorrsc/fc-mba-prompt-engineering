...
#   harmfulness, maliciousness, helpfulness, controversially, misogyny,
...
evaluators = [
    ...
    LangChainStringEvaluator(
        ...
        config={
            "criteria": {
                ...
                "Doesn't add assumptions about code that wasn't shown?"
            },
            "normalize_by": 10,
        },
    ...
    LangChainStringEvaluator(
        ...
        config={
            "criteria": {
                "format_adherence": "Did the response follow EXACTLY the format "
                "instructions? Returned ONLY valid JSON without additional text "
                "before or after? No markdown, no extra explanations?"
            },
            "normalize_by": 10,
        },
        prepare_data=prepare_with_input,  # type: ignore
    ...
    LangChainStringEvaluator(
        ...
        config={
            "criteria": {
                "code_specificity": "Does the analysis mention specific line numbers? "
                "Uses precise technical terminology (e.g., sql_injection, "
                "n_plus_1_query)? Provides actionable details instead of generic ones?"
            },
            "normalize_by": 10,
        },
        prepare_data=prepare_with_input,  # type: ignore
