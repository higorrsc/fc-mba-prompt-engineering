...
Given the JSON schema below, design REST routes and sketch
idiomatic Go handlers for CRUD.
...
Write a single-line conventional commit message summarizing
the new API based on the schema and routes.
...
Fields: id (uuid), name (string, required), description (string),
