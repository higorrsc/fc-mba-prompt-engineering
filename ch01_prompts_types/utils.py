...
def print_llm_result(prompt, response):
    ...
    console.print(
        f"[bold white]Input tokens:[/bold white] "
        f"[bright_black]{usage['prompt_tokens']}[/bright_black]"
    )
    console.print(
        f"[bold white]Output tokens:[/bold white] "
        f"[bright_black]{usage['completion_tokens']}[/bright_black]"
    )
    console.print(
